...
#SBATCH --job-name=quality_check_by_FastQC_trimmomatic
##SBATCH --time=24:00
#SBATCH --ntasks=1
#SBATCH -p smp
...
#SBATCH --error="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/03_quality_check_by_FastQC_trimmomatic.err"
#SBATCH --output="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/03_quality_check_by_FastQC_trimmomatic.out"
...
OUTPUT=/home/plstenge/seda_DNA_Corsican_wreck/04_quality_check_trimmomatic
