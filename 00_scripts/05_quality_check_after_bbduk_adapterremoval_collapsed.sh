...
#SBATCH --job-name=05_quality_check_by_FastQC_bbduk_Adapteremoval_collapsed
##SBATCH --time=24:00
#SBATCH --ntasks=1
#SBATCH -p smp
...
#SBATCH --error="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/05_quality_check_after_bbduk_Adapteremoval_collapsed.err"
#SBATCH --output="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/05_quality_check_after_bbduk_Adapteremoval_collapsed.out"
...
OUTPUT=/home/plstenge/seda_DNA_Corsican_wreck/06_quality_check_after_bbduk_adapterremoval_collapsed
