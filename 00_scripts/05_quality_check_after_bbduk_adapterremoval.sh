...
#SBATCH --job-name=05_quality_check_by_FastQC_bbduk_Adapteremoval
##SBATCH --time=24:00
#SBATCH --ntasks=1
#SBATCH -p smp
...
OUTPUT=/home/plstenge/seda_DNA_Corsican_wreck/06_quality_check_after_bbduk_adapterremoval
