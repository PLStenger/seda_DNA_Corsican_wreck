...
#SBATCH --job-name=07_quality_check_after_komplexity_trimmomatic
##SBATCH --time=24:00
#SBATCH --ntasks=1
#SBATCH -p smp
...
#SBATCH --error="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/07_quality_check_after_komplexity_trimmomatic.err"
#SBATCH --output="/home/plstenge/seda_DNA_Corsican_wreck/00_scripts/07_quality_check_after_komplexity_trimmomatic.out"
...
OUTPUT=/home/plstenge/seda_DNA_Corsican_wreck/06_quality_check_after_komplexity_trimmomatic
